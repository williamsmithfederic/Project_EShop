            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="EShop.jsp">
                                <i class="bi bi-music-note-list"></i> Catalogue
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="panier.jsp">
                                ...
                                <span class="badge bg-warning text-dark ms-1">
                                    <c:out value="${sessionScope.panier != null ? sessionScope.panier.items.size() : 0}"/>
                                </span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Checkout.jsp">
                                <i class="bi bi-credit-card"></i> Caisse
                            </a>
                        </li>
